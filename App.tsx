...
const PetCard = React.lazy(() => import('./components/PetCard.tsx'));
const WalkerCard = React.lazy(() => import('./components/WalkerCard.tsx'));
const OwnerForm = React.lazy(() => import('./components/RegisterForms.tsx').then(module => ({ default: module.OwnerForm })));
const RenterForm = React.lazy(() => import('./components/RegisterForms.tsx').then(module => ({ default: module.RenterForm })));
            ...
            <div className="space-y-16">
              <section className={`relative rounded-[2.5rem] overflow-hidden p-12 lg:p-20 flex flex-col lg:flex-row items-center justify-between shadow-clay border-4 border-white/40 ${isDarkMode ? 'bg-slate-800' : 'bg-[#FFF7ED]'}`}>
                ...
                <div className="relative mt-12 lg:mt-0 z-10 hover:rotate-2 transition-transform duration-500 cursor-pointer">
                  <img src="https://picsum.photos/seed/happy-dog/600/400" className="rounded-[2.5rem] shadow-clay border-8 border-white w-full max-w-md h-auto object-cover" alt="Happy Dog" loading="eager" fetchPriority="high" />
